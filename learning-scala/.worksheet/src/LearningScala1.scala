object LearningScala1 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(126); 
  ...
  val isBest: Boolean = picard == bestCaptain;System.out.println("""isBest  : Boolean = """ + $show(isBest ));$skip(318); 
  ...
  val doublePi = piSinglePrecision * 2;System.out.println("""doublePi  : Float = """ + $show(doublePi ));$skip(28); 
